...
This template contains additional fonts. If you use them please follow their licensing requirements.

------------------------------------------------------------------------------------------------------------------
SOME INSTRUCTIONS
------------------------------------------------------------------------------------------------------------------

• Customize the main menu background:
	You can find the file 'main_menu.png' in the game/gui folder. 

• Customize the logo in the main menu:
	You can find the file 'main_menu_logo.png' in the game/gui/overlay folder.
