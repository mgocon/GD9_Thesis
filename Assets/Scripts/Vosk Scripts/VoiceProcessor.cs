...
{
    [SerializeField] 
    [Tooltip("Select the microphone input device")]
    ...
    void Update()
    {
        if (CurrentDeviceName != selectedDevice)
        {
            ChangeDevice(Devices.IndexOf(selectedDevice));
        }
    }
#endif
    ...
    public void UpdateDevices()
    {
        ...
        // Update current device index based on selected device
        CurrentDeviceIndex = Devices.IndexOf(selectedDevice);
